    ...
    if (this.$auth.user.UserRole === 'User')
     this.items = [
        ...
        },
        {
          ...
          color: '',
          items1: [
            { title: 'หลักสูตร ปี 2560', link: 'https://eduserv.ku.ac.th//academics%202008/PDF/ku/eng/CS_B.Eng.Computer.Engineering_60.pdf' },
            { title: 'หมวดศึกษาทั่วไป ปี2559', link: 'https://registrar.ku.ac.th/wp-content/uploads/2017/05/GenEd-2559-07-10.pdf?fbclid=IwAR2HKWfOFOhkjZ5R0wZ_bb8j4NNoLQgEhCsEHQkxXyg_YAgFV7MgfAdKTbY' },
            { title: 'หมวดศึกษาทั่วไป ปี2560', link: 'http://www.cpe.eng.kps.ku.ac.th/th/images/news/education/2564/gened2564.pdf' },
        ...
        },
        {
          ...
          color: '',
          items1: [
            { title: 'ใบเสร็จรับเงิน(KU2)', link: 'https://misreg.csc.ku.ac.th/misreg/student/report_v4/ku2.php?p=1'},
            { title: 'KU3 Online', link: 'https://misreg.csc.ku.ac.th/misreg/student/ku3_online/'},
            { title: 'เพิ่ม-ถอนรายวิชา(KU4)', link: 'https://misreg.csc.ku.ac.th/misreg/student/report/ku4.php'},
            { title: 'นิสิตที่ลงทะเบียน(KU8)', link: 'https://misreg.csc.ku.ac.th/misreg/ku8/'},
          ],
          title: 'อื่น ๆ',
        },
      ]
